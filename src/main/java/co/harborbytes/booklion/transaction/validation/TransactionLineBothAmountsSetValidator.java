...
public class TransactionLineBothAmountsSetValidator implements ConstraintValidator<TransactionLineBothAmountsSetConstraint, Object> {
    @Override
    public void initialize(TransactionLineBothAmountsSetConstraint constraintAnnotation) {
...
//        return !bothCreditsAndDebitsAreSet && !bothCreditsAndDebitsAreZero;
        return !bothCreditsAndDebitsAreSet;
    }
}
